...
import { Category, CompanyRole } from 'generated/prisma-locality';
...
export class CreateWorkerAssignmentWorkerDto
  implements CreateWorkerAssignmentWorker
{
  @ApiProperty({
  ...
  implements CreateWorkerAssignment, LocalityOperationContext
{
  ...
  @ApiProperty({
    description: 'Lista de trabajadores a asignar',
